...
export const HomePage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-white py-20 w-full flex  justify-center" id="como-funciona">
        <div className="w-full max-w-4xl flex flex-col items-center justify-center gap-4 px-4">
      ...
      <div className="py-20 flex w-full justify-center" id="vacantes">
        <div className="w-full max-w-5xl flex flex-col items-center justify-center gap-4 px-4">
